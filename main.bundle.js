...
let CustomerComponent = class CustomerComponent {
    ...
    transferDataSuccess(event) {
        ...
        x.quantity = 1;
        x.productTotalPrice = x.productUnitPrice;
